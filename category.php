        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    $sql = "SELECT post.post_id, post.title, post.description, post.post_date, category.category_name, user.username,post.category,post.author, post.post_img FROM post LEFT JOIN category ON post.category = category.category_id
                    ...
                    if (mysqli_num_rows($result1) > 0) {
                        ...
                        for ($i = 1; $i <= $total_pages; $i++) {
                            ...
                            echo "<li class=\"$active\"><a href = \"index.php?cid='.$cat_id.'page=$i\">$i</li>";
